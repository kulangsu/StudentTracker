...
<h3>You&#39;re in Student Content view page</h3>
    <h3>Please Select class from drop down list<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:stdbConnectionString %>" SelectCommand="SELECT [ID], [Name] FROM [Courses]"></asp:SqlDataSource></h3>
