    ...
    <div class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:DropDownList ID="selectQuarterYear" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="selectQuarterYear_SelectedIndexChanged" DataSourceID="SqlDataSource1" SelectedValue='<%# Bind("Col1") %>'>
                    </asp:DropDownList>
                </div>
            </div>
            <div class="form-group">
